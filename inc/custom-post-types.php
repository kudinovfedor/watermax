...
function bw_get_meta_box($meta_boxes)
{
    $prefix = 'review-';
    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
            ...
            array(
                'id' => $prefix . 'client',
                'type' => 'text',
                'name' => esc_html__('Client', 'brainworks'),
                'placeholder' => esc_html__('Name Surname', 'brainworks'),
            ),
            array(
                'id' => $prefix . 'location',
                'type' => 'text',
...
add_filter('rwmb_meta_boxes', 'bw_get_meta_box');
